                                    ...
                                    <td width="40%">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                ...
                                                <td align="right" style="padding: 8px 0; font-size: 14px; color: #111827; font-weight: 500;">S/ {{ number_format($order->items ? $order->items->sum(fn($i) => $i->price * $i->quantity) : $order->total_amount, 2) }}</td>
                                            </tr>
                                            @if($order->discount_amount > 0)
                                            <tr>
                                                <td align="left" style="padding: 8px 0; font-size: 14px; color: #ef4444;">Descuento</td>
                                                <td align="right" style="padding: 8px 0; font-size: 14px; color: #ef4444; font-weight: 500;">- S/ {{ number_format($order->discount_amount, 2) }}</td>
                                            </tr>
                                            @endif
                                            <tr>
                                ...
                                <tr>
                                    <td width="50%" valign="top" style="padding-right: 16px;">
                                        ...
                                        <p style="margin: 0; font-size: 14px; line-height: 20px; color: #1f2937;">
                                            ...
                                            @if($order->shipping_province){{ $order->shipping_province }}<br>@endif
                                            @if($order->shipping_department){{ $order->shipping_department }}@endif
                                        </p>
                                    </td>
