      ...
      <div className="max-w-7xl mx-auto px-6 py-12 border-b border-gray-100">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 text-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <h4 className="font-bold text-gray-900 text-[13px]">Packs y Ofertas Exclusivas</h4>
            <p className="text-xs text-gray-500">Ahorra comprando en combo</p>
          </div>
          <div className="flex flex-col items-center gap-3">
            ...
            <h4 className="font-bold text-gray-900 text-[13px]">Suplementos Naturales</h4>
            <p className="text-xs text-gray-500">Calidad certificada y comprobada</p>
          </div>
          <div className="flex flex-col items-center gap-3">
            ...
            <h4 className="font-bold text-gray-900 text-[13px]">Compra 100% segura</h4>
            <p className="text-xs text-gray-500">Pagos con Yape, Plin, Tarjetas</p>
          </div>
          <div className="flex flex-col items-center gap-3">
            ...
            <h4 className="font-bold text-gray-900 text-[13px]">Asesoría personalizada</h4>
            <p className="text-xs text-gray-500">Escríbenos al WhatsApp</p>
          </div>
          <div className="flex flex-col items-center gap-3">
            ...
            <h4 className="font-bold text-gray-900 text-[13px]">Envío gratis desde S/100</h4>
            <p className="text-xs text-gray-500">A todo el Perú, rápido y seguro</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="space-y-6">
            <h3 className="text-xl font-black tracking-tight text-gray-900">{storeName}</h3>
            <div className="space-y-4 text-[13px] text-gray-600">
              <div>
                <p className="font-semibold text-gray-900 mb-1 flex items-center gap-2"><Phone className="w-3 h-3" /> Atención al cliente</p>
              ...
              <div>
                <p className="font-semibold text-gray-900 mb-1 flex items-center gap-2"><MapPin className="w-3 h-3" /> Dirección</p>
            ...
            <div className="flex gap-3">
              {settings?.facebook_url && (
                <Link href={settings.facebook_url} target="_blank" className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-gray-600 hover:text-accent hover:border-accent transition-colors"><FacebookIcon className="w-4 h-4" /></Link>
              )}
              {settings?.instagram_url && (
                <Link href={settings.instagram_url} target="_blank" className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-gray-600 hover:text-accent hover:border-accent transition-colors"><InstagramIcon className="w-4 h-4" /></Link>
              )}
              {settings?.tiktok_url && (
                <Link href={settings.tiktok_url} target="_blank" className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-gray-600 hover:text-accent hover:border-accent transition-colors"><TikTokIcon className="w-4 h-4" /></Link>
              )}
            </div>
            
            <div className="flex gap-2 flex-wrap text-[10px] font-bold text-gray-500 uppercase">
              <span className="px-2 py-1 rounded border border-gray-200 bg-gray-50">Pago Seguro</span>
              <span className="px-2 py-1 rounded border border-gray-200 bg-gray-50">Yape</span>
              <span className="px-2 py-1 rounded border border-gray-200 bg-gray-50">Plin</span>
              <span className="px-2 py-1 rounded border border-gray-200 bg-gray-50">Izipay</span>
              <span className="px-2 py-1 rounded border border-gray-200 bg-gray-50">Visa • Mastercard</span>
            </div>
          </div>
          ...
          {/* Column 4: Tienda & Legal */}
          <div>
            <h3 className="font-bold text-gray-900 mb-6 flex items-center gap-2">
              <span className="w-1.5 h-1.5 bg-gray-900 rounded-full"></span>
              Tienda & Legal
            </h3>
            <ul className="space-y-4 text-[13px] text-gray-600 mb-8">
              <li><Link href="#" className="hover:text-accent transition-colors">Vitaminas y Suplementos</Link></li>
              <li><Link href="#" className="hover:text-accent transition-colors">Para ti</Link></li>
              <li><Link href="#" className="hover:text-accent transition-colors">Ofertas</Link></li>
