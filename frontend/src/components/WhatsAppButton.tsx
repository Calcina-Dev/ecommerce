...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-16 top-1/2 -translate-y-1/2 bg-white text-gray-800 text-sm font-semibold py-1.5 px-3 rounded-xl shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap hidden sm:block">
        ¡Escríbenos!
      </span>
    </Link>
  );
